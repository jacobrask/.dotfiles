...
syn keyword htmlTagName contained input kbd li link map menu
...
syn keyword htmlTagName contained object optgroup q tbody tfoot thead

" new html 5 tags
syn keyword htmlTagName contained article aside audio canvas command
syn keyword htmlTagName contained datagrid details dialog embed figure
syn keyword htmlTagName contained footer header keygen mark meter nav
syn keyword htmlTagName contained output section progress ruby rt rp time

" legal arg names
syn keyword htmlArg contained action
syn keyword htmlArg contained alink alt archive
syn keyword htmlArg contained checked class code codebase
syn keyword htmlArg contained cols colspan content coords enctype
syn keyword htmlArg contained gutter height id
syn keyword htmlArg contained link marginheight
syn keyword htmlArg contained maxlength method name prompt
syn keyword htmlArg contained rel rows rowspan selected shape
syn keyword htmlArg contained size src start text type url
syn keyword htmlArg contained value vlink width
syn match   htmlArg contained "\<\(http-equiv\|href\|title\)="me=e-1

" html 4.0 arg names
syn match   htmlArg contained "\<\(accept-charset\|label\)\>"
syn keyword htmlArg contained abbr accept accesskey axis charset
...
syn keyword htmlArg contained multiple nohref object profile readonly

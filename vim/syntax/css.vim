...
syn keyword cssTagName abbr address area article aside audio a b
syn keyword cssTagName bdo blockquote body br button
syn keyword cssTagName canvas caption cite code col colgroup command datagrid dd del
syn keyword cssTagName details dfn dialog dir div dl dt embed em fieldset figure footer form
syn keyword cssTagName h1 h2 h3 h4 h5 h6 header head hr html img i
syn keyword cssTagName iframe img input ins kbd keygen label legend li
syn keyword cssTagName link map mark menu meta meter nav noscript ol output optgroup
syn keyword cssTagName option p param pre progress q ruby rt rp samp script section select small
syn keyword cssTagName span strike strong style sub sup tbody td
syn keyword cssTagName textarea tfoot th thead time title tr ul var

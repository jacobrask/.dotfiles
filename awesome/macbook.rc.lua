...
-- Default modkey.
-- Modify with xmodmap rather than here, to avoid conflicts.
modkey = "Mod4"
...
-- Maybe a widget?
myworkmenu = {
  { "VPN connect", "opera-vpn" },
  { "VPN disconnect", "opera-vpn disconnect" }
}
-- Maybe a widget?
mymonitormenu = {
  { "Work", "monitor-setup work" },
